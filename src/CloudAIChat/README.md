...
3. Once installed, Open the `Program.cs` file in the CloudAIChat.AppHost project.
...
This template leverages JavaScript libraries to provide essential functionality. These libraries are located in the wwwroot/lib folder of the CloudAIChat.Web project. For instructions on updating each dependency, please refer to the README.md file in each respective folder.
